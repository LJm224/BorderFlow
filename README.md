...
已完成工程基础、JWT 登录与刷新会话、tenant 隔离与 RBAC、商品/SKU、仓库库存档案、库存流水、订单库存分配、订单履约、审计日志和商品详情闭环。订单-库存真实 HTTP E2E 位于 `apps/api/e2e/order-inventory.e2e.mjs`。

数据看板、AI 商品上架 Agent、Shopify Mock 同步页和 CI/部署仍在后续切片中。
